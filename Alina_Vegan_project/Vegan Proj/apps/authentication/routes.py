...
def update_password():
    ...
    if new_password == confirm_password:
        ...
        db.session.commit()
        return redirect(url_for('home_blueprint.profile'))  # Redirect to the profile page
    else:
        #flash('Passwords do not match', 'error')
        return redirect(url_for('home_blueprint.profile'))  # Redirect to the profile page with an error message

# Update description route
@blueprint.route('/update-description', methods=['POST'])
